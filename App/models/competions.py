...
class Competition(db.Model):
    ...
    competionDate = db.Column(db.DateTime, default=datetime.utcnow)
    results = db.Column(db.Integer, nullable=False)

    def __init__(self, name, category, winner_id, winner, runnerup_id, runnerup, description, results, competionDate):
        self.name = name
        ...
        self.competionDate = competionDate
    ...
    def get_json(self):
        return{
            ...
            'competionDate': self.competionDate
        }